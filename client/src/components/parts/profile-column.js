...
import '../../styles/profile-column.css'
...
const ProfileColumn = (props) => {
    ...
    return(
        <div className={expanded + showHideClassName}>
            <div id='column-main'>
            <div id='edit-profile' className="d-flex justify-content-end m-1">
                    <img className="" id="edit-profile-icon" src='/icons/edit-icon.svg' alt="edit" width={30} height={30} />
                </div>
                <div id='profile-icon-container' className="d-flex justify-content-center pb-2">
