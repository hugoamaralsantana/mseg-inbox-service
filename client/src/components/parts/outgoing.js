    ...
    return (
        <div className='outgoing d-flex bg-dark ml-3 mr-3 mb-2 mt-2 flex-column justify-content-center'>
            ...
            <div className='task-reel-container d-flex bg-dark m-2 align-items-end justify-content-center h-95'>
                <TaskReel source='outgoing' name={props.reelItems[0]} endpoint={pendingTaskReelURL} />
                <TaskReel source='outgoing' name={props.reelItems[1]} endpoint={inProgressTaskReelURL} />
                <TaskReel source='outgoing' name={props.reelItems[2]} endpoint={completedTaskReelURL} />
            </div>
        </div>
    )
}
