    ...
    return (
        <div className={incomingCSS}>
          ...
          <div className='task-reel-container d-flex bg-dark m-2 align-items-end justify-content-center h-95'>
              <TaskReel source='incoming' type={props.type} showModal={props.showModal} closeModal={props.closeModal} reelTitle={props.reelItems[0]} endpoint={pendingTaskReelURL} />
              <TaskReel source='incoming' type={props.type} showModal={props.showModal} closeModal={props.closeModal} reelTitle={props.reelItems[1]} endpoint={inProgressTaskReelURL} />
              <TaskReel source='incoming' type={props.type} showModal={props.showModal} closeModal={props.closeModal} reelTitle={props.reelItems[2]} endpoint={completedTaskReelURL} />
          </div>
        </div>
    )
}
